  ...
  mount(el("div.screen.retro", {}, [
    el("div.retro-body", {}, [
      el("div.retro-appbar", {}, [
        ...
        el("div.retro-page-title", { text: "マウス・ジグラー" }),
      ]),
      el("div", { style: { padding: "40px 24px", textAlign: "center" } }, [
        el("div", { style: { fontSize: "80px", filter: "drop-shadow(0 0 16px rgba(108,240,110,.6))" }, text: "🖱" }),
        ...
        el("div", { style: { marginTop: "12px", fontSize: "13px", color: "var(--r-sub)", lineHeight: "1.7" }, text: "在席ステータス維持シミュレーター。\nPowerPotter の方向性が固まったら作り込みます。" }),
