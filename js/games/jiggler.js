...
import { el, clear, loop, clamp, pick } from "../dom.js?v=1.2.4";
import { Router } from "../app.js?v=1.2.4";
import { finishGame } from "./result.js?v=1.2.4";
import { SVG_WORKER } from "../art.js?v=1.2.4";
...
export function startJiggler(mount, gameId) {
  ...
  function appendMessage(sender, text, time, isBoss) {
    ...
    const avatarEl = isBoss
      ? el("img.teams-msg-avatar.boss", { src: "assets/img/normal.png", alt: "佐藤部長" })
