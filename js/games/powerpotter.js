...
import { el, clear, loop, clamp, pick, rand, toast } from "../dom.js?v=1.2.4";
import { Router } from "../app.js?v=1.2.4";
import { ICONS } from "./icons.js?v=1.2.4";
import { generateBossSVG } from "../art.js?v=1.2.4";
...
export function startPowerPotter(mount, gameId) {
  ...
  const BOSS_MOOD_IMG = { rage: "angry2", irritated: "angry", normal: "smile", happy: "bigsmile" };
  ...
  renderSelection();
  renderPanel();
  refs.bossFace.innerHTML = `<img class="boss-img boss-mood-normal" src="assets/img/smile.png" alt="佐藤部長"/>`;
