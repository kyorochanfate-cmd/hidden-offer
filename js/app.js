...
import { renderMenu } from "./screens/menu.js?v=1.1.1";
import { renderJobs } from "./screens/jobs.js?v=1.1.1";
import { renderGacha } from "./screens/gacha.js?v=1.1.1";
import { renderCollection } from "./screens/collection.js?v=1.1.1";
import { renderSettings } from "./screens/settings.js?v=1.1.1";
import { GAMES } from "./data.js?v=1.1.1";

// 各ミニゲームの起動関数
import { startPowerPotter } from "./games/powerpotter.js?v=1.1.1";
import { startChatRally } from "./games/chatrally.js?v=1.1.1";
import { startJiggler } from "./games/jiggler.js?v=1.1.1";
import { startExchange } from "./games/exchange.js?v=1.1.1";
