...
import { renderMenu } from "./screens/menu.js?v=1.1.6";
import { renderJobs } from "./screens/jobs.js?v=1.1.6";
import { renderGacha } from "./screens/gacha.js?v=1.1.6";
import { renderCollection } from "./screens/collection.js?v=1.1.6";
import { renderSettings } from "./screens/settings.js?v=1.1.6";
import { GAMES } from "./data.js?v=1.1.6";

// 各ミニゲームの起動関数
import { startPowerPotter } from "./games/powerpotter.js?v=1.1.6";
import { startChatRally } from "./games/chatrally.js?v=1.1.6";
import { startJiggler } from "./games/jiggler.js?v=1.1.6";
import { startExchange } from "./games/exchange.js?v=1.1.6";
import { startCommute } from "./games/commute.js?v=1.1.6";
